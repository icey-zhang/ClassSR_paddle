...
def main():
    ...
    if mode == 'pair':
        ...
        GT_folder = '/home/aistudio/DIV2K/DIV2K_valid_HR'  # fix to your path
        LR_folder = '/home/aistudio/DIV2K/DIV2K_valid_LR_bicubic/X4'  # fix to your path
        save_GT_folder = '/home/aistudio/DIV2K/DIV2K_valid_HR_sub/GT'
        save_LR_folder = '/home/aistudio/DIV2K/DIV2K_valid_HR_sub/LR'
