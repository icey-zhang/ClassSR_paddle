...
def tensor2img(tensor, out_type=np.uint8, min_max=(0, 1)):
    ...
    '''
    tensor = paddle.clip(tensor.squeeze(),min=min_max[0],max=min_max[1]).cpu()#.clamp(*min_max)  # clamp .float()
    # tensor[tensor>min_max[1]]=min_max[1]
    # tensor[tensor<min_max[0]]=min_max[0]
